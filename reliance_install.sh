...
CONFIGFOLDER='/root/.RelMN'
COIN_DAEMON='Reld'
COIN_CLI='Reld'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/zoldur/Reliance/releases/download/v1.0.0.0/Rel.tar.gz'
...
function update_config() {
  echo -e "Enter your ${RED}$COIN_NAME Masternode Private Key${NC} generated by your QT wallet."
  read -e COINKEY
